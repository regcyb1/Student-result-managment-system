                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                ...
                                                $qery = "SELECT   tblstudents.StudentName,tblstudents.RollId, tblStudents.ClassId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.RollId=:rollid ";
                                                ...
                                                <table class="table table-hover table-bordered" border="1" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                <th scope="row" colspan="2" style="text-align: center">Status</th>
                                                                <td style="text-align: center">
                                                                    <b>
                                                                        <?php
                                                                        $percentage = $totlcount * (100) / $outof;
                                                                        if ($percentage < 40) {
                                                                            // Percentage is less than 40, display "fail" status
                                                                            echo "Fail";
                                                                        } else {
                                                                            // Percentage is greater than or equal to 40, display "pass" ststus
                                                                            echo " Pass";
                                                                        }
                                                                        ?>
                                                                    </b>
